...
export const UserBadgeService = {
  ...
  getUserSummary: async (userId: number): Promise<UserBadgesSummaryDTO> => {
    const { data } = await api.get(`/api/user-badges/user/${userId}/summary`);
    return data;
  },
